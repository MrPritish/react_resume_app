    ...
    <>
      ...
      <div className='lg:flex lg:flex-row-reverse '>
        ...
        <div className='text-white rounded-tl-[20%] rounded-br-[20%] m-2 lg:m-5 lg:mt-6 p-8 lg:p-14 border-blue-400 text-center lg:w-4/5 items-center justify-center'>
          ...
          <img className='rounded-2xl border-2 sm:w-80 border-white m-auto md:w-96 w-72 lg:w-80' src={mypic} alt="img" />
          ...
          <button name='button' className=' px-6 text-lg lg:text-2xl py-2 mt-5 border-2 text-white shadow-md shadow-black lg:active:scale-90  hover:border-blue-500 rounded-full bg-cyan-700 hover:bg-cyan-900 font-bold lg:hover:scale-110 '><Link to="/about">ABOUT ME</Link></button>
