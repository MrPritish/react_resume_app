...
export default function index() {
  ...
  function show(e) {
    ...
    var y = document.getElementById("hamburger").childNodes;
    var z = document.getElementById("hamburger")
      ...
      for(var i=0 ; i<y.length ; i++)
        y[i].style.background = "rgb(239 68 68)"
  ...
  return (
    <>
      ...
      <nav className="flex justify-between lg:justify-evenly text-white py-3 sticky top-0  bg-black lg:bg-transparent lg:py-0 ">
        ...
        <div className='mx-3 mt-1 lg:hidden cursor-pointer space-y-1 ham' id='hamburger' onClick={show} >
        ...
        <div className='mx-3 lg:hidden'>
          ...
          <Link to="/"><h1 className=' text-2xl font-bold active:scale-110 cursor-pointer hover:text-red-500 hover:scale-110  '>Pritish Chepure</h1></Link>
