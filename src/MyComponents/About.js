    ...
    <>
      ...
      <div className='text-white rounded-tl-[20%] rounded-br-[20%] m-2 lg:m-5 lg:mt-12 p-8 lg:p-14 border-[2px] mt-14 border-blue-400 text-center lg:inline-block items-center justify-center'>
        ...
        <div className='mt-10 lg:float-right lg:-mt-7 lg:mr-10' >
          ...
          <img className='rounded-2xl border-2 border-white m-auto md:w-96 w-72 lg:w-80' src={mypic} alt="img" />
        ...
        <div className='mt-10 text-lg items-center justify-center font-medium lg:w-[55%] lg:mt-28 lg:ml-10 lg:text-xl xl:w-3/5'>
          ...
          <div className='mt-7 lg:mt-20 xl:-ml-24 space-y-4'>
            ...
            <button name='button' className=' px-6 text-lg lg:text-xl py-2 border-2 text-white shadow-md shadow-black lg:active:scale-90  hover:border-blue-500 rounded-full bg-cyan-700 hover:bg-cyan-900 font-bold lg:hover:scale-110 '><Link to="/skills">MY SKILLS</Link></button>
            <button name='button' className='ml-7 px-6 text-lg lg:text-xl py-2 border-2 text-white shadow-md shadow-black lg:active:scale-90  hover:border-blue-500 rounded-full bg-cyan-700 hover:bg-cyan-900 font-bold lg:hover:scale-110 '><Link to="/contact">CONTACT</Link></button>
